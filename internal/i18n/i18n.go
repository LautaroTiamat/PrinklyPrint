...
var dict = map[string]map[Lang]string{
	...
	"gen.cors_allow_any_ro": {ES: "Modo «permitir cualquier origen» (INSEGURO): lo controla el instalador. Estado: %s. Para cambiarlo, reinstalá con la opción correspondiente.", EN: "“Allow any origin” mode (INSECURE): controlled by the installer. Status: %s. To change it, reinstall with the corresponding option.", PT: "Modo «permitir qualquer origem» (INSEGURO): controlado pelo instalador. Estado: %s. Para alterá-lo, reinstale com a opção correspondente."},
	"gen.state_on":          {ES: "ACTIVADO", EN: "ENABLED", PT: "ATIVADO"},
	"gen.state_off":         {ES: "DESACTIVADO", EN: "DISABLED", PT: "DESATIVADO"},
	"gen.pair_rate_title":   {ES: "Límite de intentos de pareo", EN: "Pairing rate limit", PT: "Limite de tentativas de pareamento"},
	"gen.pair_rate_enable":  {ES: "Limitar intentos de pareo (POST /pair)", EN: "Limit pairing attempts (POST /pair)", PT: "Limitar tentativas de pareamento (POST /pair)"},
	"gen.pair_rate_per_min": {ES: "Por minuto:", EN: "Per minute:", PT: "Por minuto:"},
	"gen.pair_rate_burst":   {ES: "Ráfaga (burst):", EN: "Burst:", PT: "Rajada (burst):"},
	"gen.pair_rate_help":    {ES: "Solo afecta el pareo de orígenes nuevos; NO afecta la impresión.", EN: "Only affects pairing of new origins; does NOT affect printing.", PT: "Afeta apenas o pareamento de novas origens; NÃO afeta a impressão."},
